...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMBER] = LAYOUT_split_10x4(
    KC_ASTR,      KC_COLON,         KC_COMM,                KC_DOT,              KC_MINS,                 KC_MINS,               KC_7,                      KC_8,               KC_9,              KC_SCLN,
    _______,      _______,          _______,                KC_PLUS,             KC_EQL,                  KC_DOT,                KC_4,                      KC_5,               KC_6,              KC_EQL,
